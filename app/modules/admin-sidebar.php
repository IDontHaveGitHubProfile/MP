...
<div class="admin-sidebar-header">
    <a href="index.php?page=admin_dashboard" class="flex ai-c logo-cg">
      <svg class="logo-img" viewBox="0 0 120 120" role="img" aria-hidden="false" focusable="false">
      ...
      <div class="flex fd-c">
        <p class="ff-mb logo-title"><span class="ab-text">МОТО</span>-ПРОФИ</p>
        <p class="ff-msb logo-description">Административная панель</p>
      </div>
    </a>
  </div>
  ...
  <nav class="admin-sidebar-nav">
    <ul>
      <li><a href="index.php?page=admin_dashboard" class="admin-nav-link <?= $currentPage === 'admin_dashboard' ? 'active' : '' ?>"><i class="fas fa-home"></i><span>Главная</span></a></li>
      <li><a href="index.php?page=admin_products" class="admin-nav-link <?= $currentPage === 'admin_products' ? 'active' : '' ?>"><i class="fas fa-box"></i><span>Товары</span></a></li>
      <li><a href="index.php?page=admin_orders" class="admin-nav-link <?= $currentPage === 'admin_orders' ? 'active' : '' ?>"><i class="fas fa-shopping-cart"></i><span>Заказы</span></a></li>
      <li><a href="index.php?page=admin_categories" class="admin-nav-link <?= $currentPage === 'admin_categories' ? 'active' : '' ?>"><i class="fas fa-layer-group"></i><span>Категории</span></a></li>
      <li><a href="index.php?page=admin_users" class="admin-nav-link <?= $currentPage === 'admin_users' ? 'active' : '' ?>"><i class="fas fa-users"></i><span>Клиенты</span></a></li>
      <!-- <li><a href="index.php?page=admin_reviews" class="admin-nav-link <?= $currentPage === 'admin_reviews' ? 'active' : '' ?>"><i class="fas fa-star"></i><span>Отзывы</span></a></li> -->
      <!-- <li><a href="index.php?page=admin_delivery" class="admin-nav-link <?= $currentPage === 'admin_delivery' ? 'active' : '' ?>"><i class="fas fa-truck"></i><span>Доставка</span></a></li> -->
      <li><a href="index.php?page=admin_discounts" class="admin-nav-link <?= $currentPage === 'admin_discounts' ? 'active' : '' ?>"><i class="fas fa-percentage"></i><span>Акции</span></a></li>
    </ul>
  </nav>
  ...
  <div class="admin-sidebar-footer">
    <div class="admin-user-profile">
      <div class="admin-user-avatar">
        <?= mb_substr($_SESSION['user']['name'] ?? 'A', 0, 1) ?>
      </div>
      <div class="admin-user-info">
        <div class="admin-user-name"><?= htmlspecialchars($_SESSION['user']['name'] ?? 'Администратор') ?></div>
        <div class="admin-user-role">Администратор</div>
      </div>
<button id="logoutButton" class="admin-logout-btn" title="Выйти">
